...
public class InventoryInterfaceImpl extends CertProfileBodyTypeConfigItem implements InventoryInterface {

    private static final Logger LOGGER = LoggerFactory.getLogger(InventoryInterfaceImpl.class);
    ...
    public boolean learnEnrollmentResult(
        ...
        return ifNotNull(
                implementation,
                x -> x.learnEnrollmentResult(transactionID, certificate, serialNumber, subjectDN, issuerDN));
    }
    ...
    private void checkCreateImplementation() {
        ...
        try {
            implementation = (InventoryInterface)
                    Class.forName(implementingClass).getConstructor().newInstance();
            ...
            final String msg = "could not instanciate Inventory " + implementingClass;
            LOGGER.error(msg, e);
