 ...
 */
public class CmpCaMock implements Function<PKIMessage, PKIMessage> {
    ...
    public CmpCaMock(final String servingUrl,
        ...
        this.enrollmentCredentials = new TrustChainAndPrivateKey(
                enrollmentCredentials, TestUtils.PASSWORD_AS_CHAR_ARRAY);
    ...
    @Override
    public PKIMessage apply(final PKIMessage receivedMessage) {
        try {
