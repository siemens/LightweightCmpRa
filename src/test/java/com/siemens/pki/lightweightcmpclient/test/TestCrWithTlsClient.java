...
public class TestCrWithTlsClient extends EnrollmentTestcaseBase {

    @BeforeClass
    public static void setUpRas() throws Exception {
        initTestbed("EnrollmentConfigWithTlsClient.yaml");
    }
    ...
    @Test
    public void testCr() {
        assertTrue(enrollWithConfig("TlsClientEnrollmentConfig.yaml"));
    }
}
